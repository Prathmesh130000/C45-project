...
function preload(){
  player_running =   loadAnimation("assets/player1.png","assets/player2.png","asset/player3.png");
  player_collided = loadAnimation("assets/player1.png");
...
function draw() {
  ...
  player.x=camera.position.x-270;
  ...
  if (gameState===PLAY){
   ...
   console.log(player.y)
    ...
    if(shrubsGroup.isTouching(player)){
